...
<div style="position:absolute; right:50px; bottom:50px;" class="context-menu-one box menu-1">
 ...
 <img id="menuShow" src="pics/cog.png">
	 <img id="menuHide" src="pics/cog.png"><!--<div id="test" name="button"><img src="pics/cog.png"></div> -->
...
<div id="rc_li">
<table><tr><th colspan=2>Change Speeddial</th></tr><tr><td>name:</td><td><input class="tasktitle" id="change_id" name="'+id+'" type="text" value="'+id+'"></td></tr><tr><td>url:</td><td>
	<input class="tasktitle" id="change_url" name="'+url+'" type="text" value="'+url+'"></td></tr><tr><td>image:</td><td>
	<input class="tasktitle" id="change_img" name="'+image+'" type="text" value="'+image+'"></td></tr><tr><td>group:</td><td>
	<select id="rc_li_combo"></select></td></tr><tr><td colspan=2><input id="changeLi" value="Save Changes" type="button" /></td></tr><tr><td colspan=2><input id="removeLi" value="Remove" type="button" /></td></tr></table>
</div>
<div>
	
	<img id="togglePHshow" src="pics/shwssph.png">
	<img id="togglePHhide" src="pics/hwssph.png">

	
<img id="toggleCTshow" src="pics/uncollapsed.png">
<img id="toggleCThide" src="pics/collapsed.png">
<!--
	<img id="toggleTestShow" src="pics/uncollapsed.png">
<img id="toggleTestHide" src="pics/collapsed.png"> -->
